...
## My role
    I am working on:
        ...
        Setting up test environments and CI/CD pipeline integration

    Things that I bring from my Senior QA background:
...
## How I Work Best
    I do my best work when:
        ...
        I can focus deeply without interruptions
        
    
    I struggle when:
        I get interrupted frequently (context switching is hard in a short shift)
...
## Collaboration & Teamwork
    ...
    My biggest pet peeve in teamwork is:
        when requirements change but no one updates the ticket.
        "It works on my machine" (without verifying in the test environment).
...
## Focus & Productivity
    ...
    Things that distract me:
        Notifications from channels not relevant to my task.
...
## Feedback & Growth
    ...
    When I make a mistake, the best way to let me know is:
        Leave a comment on the PR or send a DM.
...
## Fun Facts & Quirks
    ...
    A fun fact about me:
        I enjoy 3D printing (I have a Bambu Lab A1 mini). Also like anime and gaming

My work superpower is:
    The Tester's Mindset. I can spot edge cases and potential bugs before a single line of code is written.